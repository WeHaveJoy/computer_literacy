...
create table assessment(
    ...
    intermidiate_id int,
    advanced_id int,
    FOREIGN KEY (beginner_id) REFERENCES courses_beginners(id),
    FOREIGN KEY (intermidiate_id) REFERENCES courses_intermediate(id),
    FOREIGN KEY (advanced_id) REFERENCES courses_advanced(id)
);
